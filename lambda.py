...
sns_arn = 'arn:aws:sns:ap-northeast-1:619071346215:movies_noti'
...
def lambda_handler(event, context):
    ...
    try:
        ...
        message = "movies S3 File has been processed succesfuly !!"
        ...
        print(err)
        message = "movies S3 File processing failed !!"
